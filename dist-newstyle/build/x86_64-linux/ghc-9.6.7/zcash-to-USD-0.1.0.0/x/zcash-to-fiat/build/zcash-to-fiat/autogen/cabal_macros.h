...
/* package zcash-to-USD-0.1.0.0 */
#ifndef VERSION_zcash_to_USD
#define VERSION_zcash_to_USD "0.1.0.0"
#endif /* VERSION_zcash_to_USD */
#ifndef MIN_VERSION_zcash_to_USD
#define MIN_VERSION_zcash_to_USD(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_zcash_to_USD */
...
#define CURRENT_COMPONENT_ID "zcash-to-USD-0.1.0.0-inplace-zcash-to-fiat"
