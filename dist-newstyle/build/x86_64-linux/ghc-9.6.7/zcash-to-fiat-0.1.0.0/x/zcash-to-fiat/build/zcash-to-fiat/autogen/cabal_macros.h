...
/* package zcash-to-fiat-0.1.0.0 */
#ifndef VERSION_zcash_to_fiat
#define VERSION_zcash_to_fiat "0.1.0.0"
#endif /* VERSION_zcash_to_fiat */
#ifndef MIN_VERSION_zcash_to_fiat
#define MIN_VERSION_zcash_to_fiat(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_zcash_to_fiat */
...
#define CURRENT_COMPONENT_ID "zcash-to-fiat-0.1.0.0-inplace-zcash-to-fiat"
